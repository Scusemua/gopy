...
func gopyMakeCmdExe() *commander.Command {
	cmd := &commander.Command{
		...
		Short:     "generate and compile (C)Python language bindings for Golang, and make a standalone python executable with all the code -- must provide suitable main function code",
		Long: `
